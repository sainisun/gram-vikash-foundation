...
- [ ] Push the reconciled documentation and implementation to GitHub.
...
- [ ] Exercise Member registration/update, admin financial entry, and gated-payment behavior through the implemented UI before delivery.
